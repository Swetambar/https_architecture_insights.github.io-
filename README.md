...
<head>
    ...
    <title>Architecture Blog - Home</title>
    <style>
        :root {
            --primary-color: #4b3f2f; /* dark forest */
        ...
        nav {
            ...
            align-items: center;
            background: var(--accent-color); /* terracotta */
            padding: 10px 20px;
            gap: 15px;
            flex-wrap: wrap;
        }
        ...
        nav .nav-links, nav .auth-buttons {
            display: flex;
            gap: 10px;
        }
        nav button {
        ...
        nav .profile {
            ...
            height: 35px;
            border-radius: 50%;
            background: url('/images/profile-icon.jpg') center/cover no-repeat;
            cursor: pointer;
            border: 1.5px solid white;
        }
        .category-bar {
